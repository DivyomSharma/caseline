      ...
      <div className="bg-white border border-stone-200 rounded-xl shadow-xl max-w-md w-full overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-stone-100">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-xs font-bold text-stone-800 uppercase tracking-wider">Register Complainant / Victim</h3>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4 text-xs font-semibold text-stone-700">
          ...
          <div className="space-y-1">
            <label className="block text-[10px] text-stone-400 uppercase font-bold">Contact Phone</label>
            <input
              type="text"
              required
              value={contact}
          ...
          <div className="space-y-1">
            <label className="block text-[10px] text-stone-400 uppercase font-bold">Residential Address</label>
            <input
              type="text"
              required
              value={address}
          ...
          <div className="space-y-1">
            <label className="block text-[10px] text-stone-400 uppercase font-bold">Case Log Notes</label>
            <textarea
              value={notes}
