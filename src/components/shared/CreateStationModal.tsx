      ...
      <div className="bg-white border border-stone-200 rounded-xl shadow-xl max-w-md w-full overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-stone-100">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-xs font-bold text-stone-800 uppercase tracking-wider">Register Station Precinct</h3>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4 text-xs font-semibold text-stone-700">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              <label className="block text-[10px] text-stone-400 uppercase">Station Name</label>
              <input
                type="text"
                required
                value={name}
            ...
            <div className="space-y-1">
              <label className="block text-[10px] text-stone-400 uppercase">Station Code</label>
              <input
                type="text"
                required
                value={code}
          ...
          <div className="space-y-1">
            <label className="block text-[10px] text-stone-400 uppercase">District Region</label>
            <input
              type="text"
              required
              value={district}
          ...
          <div className="space-y-1">
            <label className="block text-[10px] text-stone-400 uppercase">Address Location</label>
            <input
              type="text"
              required
              value={address}
          ...
          <div className="space-y-1">
            <label className="block text-[10px] text-stone-400 uppercase">precinct contact number</label>
            <input
              type="text"
              required
              value={contact}
